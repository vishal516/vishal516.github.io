...
var gameobjects = {
    ...
    "player": {
        ...
        "animationframe": 0,
        "img": ["player0", "player1", "player2", "player3", "player4"],
        "imgpos": {
            "x": 20,
            "y": 10,
            "width": 40,
    ...
    "images": ['images/background.jpg',
        ...
        'images/enemies/Walk/enemy56.png',
    ...
    "sounds": ['media/Button.m4a', 'media/gamemusic.ogg', 'media/gameover.ogg', //============================================ SPECIFIC ============================================
        'media/ammo.ogg', 'media/life.ogg', 'media/crow.ogg', 'media/jump.ogg', 'media/noammo.ogg', 'media/shot.ogg', 'media/blast.ogg'
    ]
};
var GUI = {
    "canvas": {
...
function houseConstructor() {
    ...
    this.width = function() {
        if (x.type == 1) return 2 * 250;
        if (x.type == 2) return 2 * 420;
        if (x.type == 3) return 2 * 400;
        if (x.type == 4) return 2 * 230;
        if (x.type == 5) return 2 * 320;
    }();

    this.height = function() {
        if (x.type == 1) return 2 * 140;
        if (x.type == 2) return 2 * 300;
        if (x.type == 3) return 2 * 350;
        if (x.type == 4) return 2 * 240;
        if (x.type == 5) return 2 * 300;
    }();
...
function enemyConstructor() {
    ...
    this.img = function() {
        ...
        if (x.type == 3) return ['crow0', 'crow1', 'crow2', 'crow3', 'crow4', 'crow5'];
        if (x.type == 4) return ['shooter'];
        if (x.type == 5) return ['enemy50', 'enemy51', 'enemy52', 'enemy53', 'enemy54', 'enemy55', 'enemy56'];
    }();
    ...
    this.y = function() {
        ...
        if (x.type == 3) return GUI.canvas.height / 2;
