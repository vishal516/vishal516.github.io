...
function renderUI() {
    ...
    } else if (gameobjects.gamestate == gameobjects.states.play) //play
    {
        ...
        spriteWrite('TARGET:' + gameobjects.player.target, fontMedium, 100, 10, false);
        spriteWrite('SCORE:' + gameobjects.player.score, fontMedium, 480, 10, false);
        spriteWrite('LEVEL:' + gameobjects.player.level, fontMedium, 800, 10, false);
        spriteWrite('TIME:' + gameobjects.player.time.toString().toHHMMSS(), fontMedium, 1100, 10, false);
    ...
    {
        spriteWrite('PRESS DOWN BUTTON FOR FISHING', fontClear, 780, 350, true);
        spriteWrite('PRESS UP BUTTON TO DROP BOMBS', fontClear, 780, 450, true);
        spriteWrite('PRESS LEFT BUTTON TO MOVE LEFT', fontClear, 780, 550, true);
        spriteWrite('PRESS RIGHT BUTTON TO MOVE RIGHT', fontClear, 780, 650, true);
        spriteWrite('PRESS OK BUTTON TO GO BACK TO MAIN MENU', fontClear, 780, 750, true);
    }
}
