...
function renderUI() {
    ...
    } else if (gameobjects.gamestate == gameobjects.states.play) //play
    {
        ...
        spriteWrite('TARGET:' + gameobjects.player.target, fontMedium, 200, 20, false);
        spriteWrite('SCORE:' + gameobjects.player.score, fontMedium, 680, 20, false);
        spriteWrite('LEVEL:' + gameobjects.player.level, fontMedium, 1100, 20, false);
        spriteWrite('HEALTH:' + gameobjects.player.health, fontMedium, 480, 935, false);
        spriteWrite('EARTH:' + gameobjects.earth.health, fontMedium, 850, 935, false);
    ...
    } else if (gameobjects.gamestate == gameobjects.states.overfail) // overfailed
    {
        ...
        spriteWrite('PRESS OK BUTTON TO GO BACK TO MAIN MENU', fontMedium, 820, 750, true);
    } else if (gameobjects.gamestate == gameobjects.states.info) // info
    {
        spriteWrite('PRESS ARROW BUTTONS TO MOVE THe SHIP', fontMedium, 820, 550, true);
        spriteWrite('PRESS OK BUTTON TO GO BACK TO MAIN MENU', fontMedium, 820, 650, true);
    }
}
